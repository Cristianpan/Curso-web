...
(33, 1, 'Casa en la playa', 1230000.00, 'e0db5c0af2f6aa392a4045cb7c60fd5d.jpg', 'Casa en la playa con piscina incluida. Cuenta con lo indispensable para tener una buena estadía', 5, 3, 2, '2023-05-14');
INSERT INTO `propiedades` (`id`, `vendedorId`, `titulo`, `precio`, `imagen`, `descripcion`, `habitaciones`, `wc`, `estacionamiento`, `creado`) VALUES
(34, 1, 'Departamento en renta', 70000.00, '6b1e1ae47d8f16f8108e76f8b5ece968.jpg', 'Departamento amueblado. Ideal para joven estudiante', 2, 1, 1, '2023-05-14');
INSERT INTO `propiedades` (`id`, `vendedorId`, `titulo`, `precio`, `imagen`, `descripcion`, `habitaciones`, `wc`, `estacionamiento`, `creado`) VALUES
(35, 6, 'Casa en el bosque', 2500000.00, '6ddd91c6084ca0bbec09755a2e6a8463.jpg', 'Casa en el bosque, excelente lugar para descansar', 4, 2, 2, '2023-05-14');
